...
export default function Tawjihi2009JordanHistory() {
  ...
  const description =
    "امتحانات إلكترونية وبنك أسئلة تاريخ الأردن لتوجيهي 2009 في الأردن. اختر الفصل (الأول/الثاني) واستعرض الامتحانات حسب الوحدة.";

  const keywords =
    "امتحانات تاريخ الاردن توجيهي 2009, امتحانات تاريخ الأردن توجيهي 2009, بنك اسئلة تاريخ الاردن, بنك أسئلة تاريخ الأردن, امتحانات وزارية تاريخ الأردن, نمط الوزارة تاريخ الأردن, توجيهي الاردن 2009 تاريخ, احداث وتواريخ ومعاهدات, اسئلة وزارية تاريخ الأردن";
...
ستجد هنا الامتحانات مرتبة حسب الفصل الأول والفصل الثاني (وقريبًا حسب الوحدات أيضًا)، لتراجع بطريقة منظمة وتعرف نقاط الضعف بسرعة.
