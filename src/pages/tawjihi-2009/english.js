...
export default function Tawjihi2009English() {
  ...
  const description =
    "امتحانات إلكترونية وبنك أسئلة اللغة الإنجليزية لتوجيهي 2009 في الأردن. وزاري تفاعلي قريب من النمط الوزاري المعتمد ومقسّم حسب المنهاج المعتمد. اختر الفصل (الأول/الثاني) واستعرض الامتحانات حسب الوحدة.";

  const keywords =
    "امتحانات انجليزي توجيهي 2009, امتحانات إنجليزي توجيهي 2009, بنك اسئلة انجليزي توجيهي, بنك أسئلة إنجليزي توجيهي, امتحانات الكترونية انجليزي, توجيهي الاردن 2009 انجليزي, نمط الوزارة انجليزي, امتحانات وزارية انجليزي, وزاري تفاعلي, نمط وزاري, اسئلة تفاعلية, حسب النمط الوزاري, حسب المنهاج المعتمد, Tawjihi 2009 English, grammar exam, reading exam, vocabulary, electronic exams";

  // ✅ روابط الفصول (نفس نظام العربي)
  const term1Url = "/tawjihi-2009/english/term-1";
  const term2Url = "/tawjihi-2009/english/term-2";

  // ✅ صفحة توجيهي 2009  — لا تغيّرها
...
الامتحانات مصممة لتقيس فهمك وتدربك على شكل السؤال والخيارات المتوقعة وفق النمط الوزاري، وتساعدك ترفع جاهزيتك بسرعة قبل الامتحان.`;
  ...
  // ✅ نص إضافي مهيكل لتقوية الكلمات المستهدفة (داخل الصفحة)
  const seoIntroShort =
    "هذا بنك أسئلة إنجليزي لتوجيهي 2009 مصمم بأسلوب وزاري تفاعلي قريب من النمط الوزاري المعتمد. ستجد أسئلة تفاعلية مرتبة حسب المنهاج المعتمد تشمل Grammar وReading وVocabulary مع نماذج امتحانات تساعدك على التدريب بسرعة على الموبايل أو الكمبيوتر.";

  // ✅ روابط Long-tail داخلية (بدون صفحات جديدة)
  const quickLinks = [
    {
      label: "امتحانات إنجليزي توجيهي 2009 فصل أول – وزاري تفاعلي",
      href: term1Url,
    },
    {
      label: "امتحانات إنجليزي توجيهي 2009 فصل ثاني – نمط وزاري",
      href: term2Url,
    },
    {
      label: "بنك أسئلة إنجليزي توجيهي 2009 حسب النمط الوزاري المعتمد",
      href: term1Url,
    },
    {
      label: "أسئلة تفاعلية إنجليزي توجيهي 2009 حسب المنهاج المعتمد",
      href: term2Url,
    },
  ];
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 max-w-6xl mx-auto" dir="rtl">
        ...
        >
          <ol className="flex flex-wrap items-center gap-2 justify-center sm:justify-start">
            ...
            <li className="text-gray-500">/</li>
            <li className="text-yellow-300 font-bold">اللغة الإنجليزية</li>
          </ol>
        </nav>
        ...
        <section className="mt-10 bg-gray-800/50 border border-yellow-500/10 rounded-2xl p-5 sm:p-6">
          <h2 className="text-lg sm:text-xl font-extrabold text-yellow-300">
            بنك أسئلة إنجليزي توجيهي 2009 حسب النمط الوزاري
          </h2>

          <p className="mt-3 text-sm sm:text-base text-gray-200 leading-7 sm:leading-relaxed">
            هذه الصفحة تجمع لك بنوك أسئلة وامتحانات إنجليزي توجيهي 2009 بأسلوب
            وزاري تفاعلي قريب من النمط الوزاري المعتمد، مع أسئلة تفاعلية مرتبة
            حسب المنهاج المعتمد لتقوية مهارات Grammar وReading وVocabulary.
          </p>
          ...
          <ul className="mt-3 text-sm sm:text-base text-gray-200 leading-7 sm:leading-relaxed space-y-2">
            <li>
              • امتحانات إلكترونية تفاعلية للإنجليزي لتوجيهي الأردن 2009.
            </li>
        ...
        <section className="mt-10 bg-gray-800/50 border border-yellow-500/10 rounded-2xl p-5 sm:p-6">
          <h2 className="text-lg sm:text-xl font-extrabold text-yellow-300">
            أسئلة شائعة عن بنك أسئلة إنجليزي توجيهي 2009
          </h2>
