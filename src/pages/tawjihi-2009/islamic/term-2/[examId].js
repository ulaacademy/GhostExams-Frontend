...
export default function IslamicTerm1ExamSEO({ exam }) {
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "التربية الإسلامية", item: `${siteUrl}/tawjihi-2009/islamic` },
      { "@type": "ListItem", position: 3, name: "الفصل الأول", item: `${siteUrl}/tawjihi-2009/islamic/term-1` },
