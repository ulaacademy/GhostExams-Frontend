...
export default function IslamicTerm2({ exams, usedFallback }) {
  ...
  const keywords = [
    ...
    "امتحانات تربية اسلامية توجيهي 2009",
    "بنك اسئلة دين توجيهي 2009",
    "بنك اسئلة تربية اسلامية",
    "امتحانات الكترونية دين",
    "نمط وزاري دين",
    "توجيهي الاردن 2009 دين",
    "GhostExams",
  ].join(", ");
...
اعرض معاينة أي امتحان من الكروت، أما التقديم الفعلي فيكون من داخل حساب الطالب بعد تفعيل الاشتراك.`;
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "نعم، المحتوى مبني على المنهاج الرسمي ومقسّم حسب وحدات الفصل.",
    },
    {
  ...
  const relatedLinks = [
    ...
    { label: `الفصل الأول - ${subjectShort}`, href: `/tawjihi-2009/${subjectSlug}/term-1`, desc: "الانتقال لقائمة امتحانات الفصل الأول" },
